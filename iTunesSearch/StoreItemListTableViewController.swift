...
class StoreItemListTableViewController: UITableViewController {
    ...
    var itemControllerProperty = StoreItemController()
    ...
    func fetchMatchingItems() {
        ...
        if !searchTerm.isEmpty {
            ...
            let mediaQuerryItem = URLQueryItem(name: "media", value: mediaType)
            ...
            Task {
                do {
                    let fetchedItems = try await itemControllerProperty.fetchItems(matching: [termQueryItem, mediaQuerryItem, langQueryItem])
